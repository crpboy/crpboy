...
- 🌱 My study field: **operating system**, **CPU architecture**.
- ⚒️ I'm working on **[NoAxiom](https://github.com/NoAxiom)**, a rust-based **operating system kernel**, which won first prize in CSCC OS kernel competition.
